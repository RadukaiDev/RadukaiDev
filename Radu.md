...
<div align="center">
  ...
  <p>
    Desarrollo de software · Java · Spring Boot · Python · JavaScript
    <br>
    Bases de Datos · AWS · Robótica · Docencia
  </p>
...
Me interesa especialmente el desarrollo de aplicaciones utilizando **Java y Spring Boot**, la administración y diseño de **bases de datos**, el desarrollo web y la implementación de soluciones tecnológicas.
...
`Spring Boot` · `Spring Security` · `Desarrollo Web` · `APIs REST`
...
`PostgreSQL` · `MySQL` · `Modelado de Datos` · `SQL`
...
Desarrollo de aplicaciones y sistemas utilizando Java.
...
Tengo experiencia trabajando con tecnologías orientadas al desarrollo de aplicaciones web:
